...
export default function ProofOfExistence (props) {
  ...
  }, [digest, api.query.assethandlerModule]);
      ...
      <Form success={!!digest && !isClaimed()} warning={isClaimed()}>
        ...
        <Form.Field>
          ...
          <TxButton
            ...
            setStatus={setStatus}
            type='TRANSACTION'
            attrs={{ params: [digest], tx: api.tx.assethandlerModule.createClaim }}
          ...
          <TxButton
            ...
            setStatus={setStatus}
            type='TRANSACTION'
            attrs={{ params: [digest], tx: api.tx.assethandlerModule.revokeClaim }}
